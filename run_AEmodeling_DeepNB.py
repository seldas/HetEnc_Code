...
def main(curr_wd = './DeepNB/', data_format = 'Raw'):		
	#### Load dataset #####
	...
	param_cache = (curr_wd, batch_size, verbose, randSeed, epochs, featureOut, acti_funcs, drop_rates, data_format)
...
def AE_modeling(x_1, x_2, param_cache):
	(curr_wd, batch_size, verbose, randSeed, epochs, featureOut, acti_funcs, drop_rates, data_format) = param_cache
